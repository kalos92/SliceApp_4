...
public class Up_Img_pay extends AsyncTask<Void, Integer, Void> {
    ...
    public Up_Img_pay(GregorianCalendar data, Gruppo gruppo, Persona buyer, String nome, String price, String cat, Policy policy, Persona user, Context context, FragmentActivity fa,Bitmap b){
        this.buyer=buyer;
        this.cat=cat;
        this.price=price;
        this.nome=nome;
